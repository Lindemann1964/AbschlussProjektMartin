fun main(){
    ...
    var list= mutableListOf<Panzer>(a1,a2,a3,a4,b1,b2,b3,b4,c1,c2,c3,c4,d1,d2,d3,d4,e1,e2,e3,e4,f1,f2,f3,f4,g1,g2,g3,g4,h1,h2,h3,h4)
    list.shuffle()
    var spielerListe= list.slice(0..15).toMutableList()      // Karten werden zu gleichen Teilen verteilt
    var computerListe= list.slice(16..31).toMutableList()
    //println(spielerListe.size)
    //println(computerListe.size)
        // for (p in spielerListe){
       // println(p.eckZeichen)
}
